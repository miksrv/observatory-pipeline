...
- [feedback_module_to_package_split.md](feedback_module_to_package_split.md) — Four compatibility rules (attribute-chain patches, bare-name patches, direct-call re-exports, orchestrator-needs-qualified-access) for splitting a modules/*.py file into a package without breaking tests
